...
export const ANDROID_IM_LOC = {
  ...
  /** 底栏送礼按钮（气泡消息里也有 iv_gift，必须限定在输入区） */
  chatGift: by.xpath(
    `//*[@resource-id='${xid('layout_input')}' or @resource-id='${xid('input')}']//*[@resource-id='${xid('iv_gift')}']`,
  ),
  ...
  /** 表情面板 / 礼物面板 / 气泡 */
  emojiPanel: id('emoji_all_view'),
  emojiList: id('rv_emojis'),
  emojiItem: id('iv_pic'),
  emojiBubbleLottie: id('emojiLottieView'),
  emojiBubbleBorder: id('emojiBorderView'),
  giftPanelRoot: id('sendGiftRootLayout'),
  ...
  atUserName: id('userNameTv'),
  atSelectorClose: id('closeIv'),
